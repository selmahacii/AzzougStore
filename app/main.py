...
def run_db_migrations():
    ...
    statements = [
        ...
        "UPDATE orders SET status = 'NEW', is_abandoned_cart = FALSE WHERE store_sequence_number IN (763, 764, 765, 766, 767, 768) OR customer_phone IN ('0656644079', '0655629476', '0661346602', '0699885641', '0555760602', '0782214097') OR id LIKE 'bb5a654f%' OR id LIKE 'cfd361fe%' OR id LIKE 'f9748fcb%' OR id LIKE '120abf9a%' OR id LIKE 'e21b4770%' OR id LIKE '64eccf6e%'",
