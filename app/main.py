...
def run_db_migrations():
    ...
    statements = [
        ...
        "UPDATE orders SET status = CASE WHEN status = 'ABANDONED' THEN 'NEW' ELSE status END, is_abandoned_cart = FALSE WHERE store_sequence_number BETWEEN 740 AND 775 OR customer_phone IN ('0671510838', '0783217866', '0772037916', '0558333782', '0672196206', '0549302112', '0555950958', '0541217581', '0564621691', '0656644079', '0655629476', '0661346602', '0699885641', '0555760602', '0782214097') OR id LIKE 'fd53c3b9%' OR id LIKE '8438f526%' OR id LIKE '239d28de%' OR id LIKE '369486aa%' OR id LIKE '09c53cda%' OR id LIKE 'cda83f70%' OR id LIKE '13d2b9cc%' OR id LIKE 'bc976660%' OR id LIKE 'a27d3824%' OR id LIKE 'bb5a654f%' OR id LIKE 'cfd361fe%' OR id LIKE 'f9748fcb%' OR id LIKE '120abf9a%' OR id LIKE 'e21b4770%' OR id LIKE '64eccf6e%'",
