...
import { Search, Package, Loader2, Boxes } from 'lucide-react';
 ...
 * only need to check what's currently in stock. Replaces the full admin
 * ProductsPage + InventoryDashboard (CRUD + analytics) with a single
 * searchable list showing name, image, variants and a stock badge.
 */
