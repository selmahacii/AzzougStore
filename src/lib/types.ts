...
export const VALID_TRANSITIONS: Record<OrderStatus, OrderStatus[]> = {
  ...
  IN_PROGRESS: ['CONFIRMED', 'CANCELLED', 'RESCHEDULED', 'IN_PROGRESS', 'RECOVERED_CART', 'SHIPPED'],
  RESCHEDULED: ['CONFIRMED', 'CANCELLED', 'IN_PROGRESS', 'RESCHEDULED', 'RECOVERED_CART', 'SHIPPED'],
  ...
  CANCELLED:   ['CONFIRMED', 'IN_PROGRESS', 'RECOVERED_CART', 'RESCHEDULED', 'NEW'],
